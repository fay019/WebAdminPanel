...
<div class="container">
    <div class="header">
        ...
        <nav id="mainNav" class="nav">
            <?php if (is_logged_in()): ?>
                <a href="/dashboard.php" title="Dashboard" aria-label="Dashboard"><img src="/img/menu/dashboard.svg" class="nav-icon" alt="" role="presentation"></a>
                ...
                <a href="/users_list.php" title="Utilisateurs" aria-label="Utilisateurs"><img src="/img/menu/users.svg" class="nav-icon" alt="" role="presentation"></a>
